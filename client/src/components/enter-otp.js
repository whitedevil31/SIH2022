...
export default function EnterOtp(){
    ...
    <div className="main">
    <div class="mb-4">
      <input class="shadow appearance-none border rounded w-full py-2 px-5 text-gray-700 leading-tight focus:outline-none focus:shadow-outline input-box" id="username" type="text" placeholder="Enter your Aadhar Number" />
    </div>
